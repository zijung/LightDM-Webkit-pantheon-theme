...
MenuController.prototype.buildPowerMenu = function() {
	if (lightdm.can_suspend) {
		$('<li><a href="#" id="suspend">Suspend</a></li>').appendTo('#powerMenu > ul');
	}
	if (lightdm.can_restart) {
		$('<li><a href="#" id="restart">Restart</a></li>').appendTo('#powerMenu > ul');
	}
	if (lightdm.can_shutdown) {
		$('<li><a href="#" id="shutdown">Shutdown</a></li>').appendTo('#powerMenu > ul');
	}
};
